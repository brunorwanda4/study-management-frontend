...
import TableList from "@/components/table/s-t/table-student-list";
...
const SchoolStaffStudentPage = ({ lang }: props) => {
  return (
    <div className="p-4 space-y-4 ">
      ...
      <StaffPeople icon="/icons/student.png" lang={lang} total={762} title='Students' Ftotal={60} Mtotal={37} role='Total students'/>
