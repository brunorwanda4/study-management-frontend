...
import { deleteClassRoomAPI } from "@/service/admin/fetchDataFn";
      ...
      <AlertDialogContent className="happy-card">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            room account and the class room will no longer be able to access the
            system again. 😔 Please proceed with caution.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <div className="mt-2">
