...
import { SectorModelGet, SectorModelPut } from "@/lib/types/sectorModel";
import { updateSectorAPI } from "@/service/admin/fetchDataFn";
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button library="daisy" variant="warning" size="xs">
          update
          {isPending && (
            <LoaderCircle
