...
const StudentStatus = ({ lang, status, role }: props) => {
  return (
    <div className=" happy-card p-0">
      <div className=" flex justify-between px-4 py-2 border-b border-b-border">
        <div className="   flex gap-2 space-x-1 items-center">
          ...
          <h5 className=" happy-title-base text-my">{status}</h5>
        </div>
      ...
      <div className=" p-4 flex flex-col space-y-4">
        <div className=" flex justify-between ">
            <div className="flex items-center space-x-2">
                <span className="happy-title-base">Available space:</span>
                <div className=" font-semibold text-3xl" >40</div>
            </div>
            <div className="flex items-center space-x-2">
                <span className="happy-title-base">Registered new {role}:</span>
