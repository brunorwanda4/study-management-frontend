...
export const validSchoolStaffRoles = SchoolStaffRoles.map(
  (role) => role.value,
) as [string, ...string[]];
...
export const TvetPrograms: Option[] = [
  ...
  {
    value: "AUTO_ELECTRICITY_ELECTRONICS",
    label: "Auto Electricity and Electronics",
  },
  ...
  {
    value: "COMPUTER_SYSTEMS_TECHNOLOGY",
  ...
  {
    value: "NETWORKING_INTERNET_TECHNOLOGIES",
    label: "Networking and Internet Technologies",
  },
  ...
  {
    value: "COMPUTER_SYSTEM_ARCHITECTURE",
    label: "Computer System and Architecture",
  }, // Listed as Level 3, but relevant for advanced study
  {
    value: "SOFTWARE_PROGRAMMING_EMBEDDED_SYSTEMS",
    label: "Software Programming and Embedded Systems",
  }, // Listed as Level 3, but relevant for advanced study
  ...
  {
    value: "CASH_CROP_PRODUCTION_PROCESSING",
    label: "Cash Crop Production and Processing",
  },
  {
    value: "PIG_PRODUCTION_PROCESSING",
    label: "Pig Production and Processing",
  },
  { value: "FISH_FARMING_PROCESSING", label: "Fish Farming and Processing" },
  {
    value: "FOOD_CROP_PRODUCTION_PROCESSING",
    label: "Food Crop Production and Processing",
  },
  {
    value: "POULTRY_FARMING_PROCESSING",
    label: "Poultry Farming and Processing",
  },
  {
    value: "FRUITS_VEGETABLES_PRODUCTION_PROCESSING",
    label: "Fruits and Vegetables Production and Processing",
  },
  {
    value: "RUMINANT_FARMING_PROCESSING",
    label: "Ruminant Farming and Processing",
  },
  { value: "BAKING", label: "Baking" },
  {
    value: "AGRICULTURE_MECHANIZATION_TECHNOLOGY",
    label: "Agriculture Mechanization Technology",
  }, // Bachelor of Technology
  { value: "APPLIED_FORESTRY", label: "Applied Forestry" }, // Bachelor of Technology
  {
    value: "WILDLIFE_LANDSCAPE_MANAGEMENT",
    label: "Wildlife and Landscape Management",
  }, // Bachelor of Technology
  {
    value: "TOURISM",
    label: "Tourism (Advanced Diploma/Bachelor of Technology)",
  }, // Listed in multiple contexts
  {
    value: "GEOMATICS_LAND_SURVEYING",
    label: "Geomatics (Land Surveying) (Bachelor of Technology)",
  }, // Bachelor of Technology
  {
    value: "HIGHWAY_TECHNOLOGY",
    label: "Highway Technology (Bachelor of Technology)",
  }, // Bachelor of Technology
  {
    value: "IRRIGATION_DRAINAGE_TECHNOLOGY",
    label: "Irrigation and Drainage Technology (Bachelor of Technology)",
  }, // Bachelor of Technology
  {
    value: "WATER_SANITATION_TECHNOLOGY",
    label: "Water and Sanitation Technology (Bachelor of Technology)",
  }, // Bachelor of Technology
  {
    value: "QUANTITY_SURVEYING",
    label: "Quantity Surveying (Bachelor of Technology)",
  }, // Bachelor of Technology
  // Advanced Diploma programs listed as main programs at IPRC Kigali, potentially leading to BTech
  {
    ...
    label: "Mechanical Engineering (Advanced Diploma)",
  },
  { value: "CIVIL_ENGINEERING", label: "Civil Engineering (Advanced Diploma)" },
  {
    value: "INFORMATION_COMMUNICATION_TECHNOLOGY",
    label: "Information and Communication Technology (Advanced Diploma)",
  },
  {
    value: "ELECTRICAL_ELECTRONICS_ENGINEERING",
    label: "Electrical and Electronics Engineering (Advanced Diploma)",
  },
  {
    value: "MINING_ENGINEERING",
    label: "Mining Engineering (Advanced Diploma)",
  },
  {
    value: "TRANSPORT_LOGISTICS",
    label: "Transport and Logistics (Advanced Diploma)",
  },
