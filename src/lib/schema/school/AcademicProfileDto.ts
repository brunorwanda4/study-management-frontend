...
export const AcademicProfileDtoSchema = z.object({
  ...
  aLevelSubjectCombination: z
    .array(z.string())
    .optional()
    .describe("A-Level subject combinations."),
  ...
  aLevelOptionSubjects: z
    .array(z.string())
    .optional()
    .describe("A-Level optional subjects."),
  ...
  tvetSpecialization: z
    .array(z.string())
    .optional()
    .describe("TVET specializations offered."),
   ...
   */
  tvetOptionSubjects: z
    .array(z.string())
    .optional()
    .describe("TVET optional subjects or modules."),
});

// You can infer the TypeScript type from the schema if needed:
export type InferredAcademicProfileDto = z.infer<
  typeof AcademicProfileDtoSchema
>;
